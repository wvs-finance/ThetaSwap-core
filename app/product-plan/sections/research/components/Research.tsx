...
// ---------------------------------------------------------------------------
// Delta-plus Distribution Histogram (SVG)
// ---------------------------------------------------------------------------
      ...
      <article className="mx-auto max-w-[960px] px-8 py-10 font-[family-name:'IBM_Plex_Sans']">
        ...
        <section className="mb-10">
          <h2 className="mb-3 font-[family-name:'Instrument_Serif'] text-xl italic text-slate-200">
            <span className="mr-2 font-[family-name:'IBM_Plex_Mono'] text-sm not-italic text-zinc-500">S1</span>
            Abstract
          </h2>
        ...
        <section className="mb-10">
          <h2 className="mb-3 font-[family-name:'Instrument_Serif'] text-xl italic text-slate-200">
            <span className="mr-2 font-[family-name:'IBM_Plex_Mono'] text-sm not-italic text-zinc-500">S2</span>
            Methodology
          </h2>
        ...
        <section className="mb-10">
          <h2 className="mb-4 font-[family-name:'Instrument_Serif'] text-xl italic text-slate-200">
            <span className="mr-2 font-[family-name:'IBM_Plex_Mono'] text-sm not-italic text-zinc-500">S3</span>
            Results
          </h2>
          ...
          {/* Chart 2: Delta-plus Distribution */}
          <div className="mb-8">
            <h3 className="mb-1 text-sm font-medium text-slate-300">
        ...
        <section className="mb-10">
          <h2 className="mb-4 font-[family-name:'Instrument_Serif'] text-xl italic text-slate-200">
            <span className="mr-2 font-[family-name:'IBM_Plex_Mono'] text-sm not-italic text-zinc-500">S4</span>
          ...
          <p className="mt-2 text-xs text-zinc-500">
            See S2, Payoff Function for parameter usage. Values calibrated from ETH-USDC 30bps backtest.
        ...
        <section className="mb-10">
          <h2 className="mb-3 font-[family-name:'Instrument_Serif'] text-xl italic text-slate-200">
            <span className="mr-2 font-[family-name:'IBM_Plex_Mono'] text-sm not-italic text-zinc-500">S5</span>
            Conclusion
          </h2>
          <p className="leading-relaxed text-slate-300">
