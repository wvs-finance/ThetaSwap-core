...
import type { Pool, PoolExplorerProps, PoolFilters } from '@/../product/sections/pool-explorer/types'
          ...
          <thead className="sticky top-0 z-10 border-b border-zinc-800 bg-zinc-900/95 backdrop-blur-sm">
            <tr>
              ...
              <ColumnHeader
                ...
                onSort={handleSort}
                align="right"
                tooltip="Δ⁺ = fee concentration severity. 0 = competitive, 1 = fully extracted. Derived from Σ(1/ℓ_k) over position removals."
              />
