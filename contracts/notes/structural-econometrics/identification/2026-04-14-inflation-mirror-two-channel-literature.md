...
| Berganza & Broto 2012 (JIMF; SSRN 1853310) | 1995-Q1 | 2010-Q1 | CL, CO, MX, PE + 4 non-LatAm EM (Colombia is a panel member with separate GARCH) | local/USD | daily | FX conditional variance (GARCH) | NO CPI surprise — RHS is intervention dummy + IT-regime dummy [full-text-blocked on exact spec] | intervention dummy, IT dummy, lagged vol | not in abstract | C | Colombia has a panel-member FX-vol GARCH, but the inflation channel enters only through the IT-regime dummy — no CPI-release surprise is constructed; large surprise-construction distance | GARCH infrastructure portable, but their RHS does not estimate the channel-π β directly; cannot cite as lemma for adj-R² ≥ τ_lit |
| Clarida & Waldman 2007 (NBER w13010; SSRN 913306) | 2001-07 | 2005-03 | AU, CA, EZ, JP, NZ, NO, SE, CH, UK, US (G10; NO Colombia) | 10 local/USD pairs | intraday (10-min windows) | FX level (log-return around announcement) | CPI release minus Bloomberg consensus | IT-regime dummy | R² > 0.25 pooled on core CPI | D | Shared IT-regime structure with Colombia but (i) LHS is FX level not realized vol, (ii) G10 currencies only — not an EM commodity exporter; two-dimensional distance | Coefficient direction (bad-CPI-news → appreciation under credible IT) is portable priors; magnitude not portable to cCOP/X |
