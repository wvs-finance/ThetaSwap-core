...
# This file lives at:
#   <worktree_root>/contracts/notebooks/fx_vol_cpi_surprise/Colombia/env.py
# parents[0] = Colombia/
...
_COLOMBIA_DIR: Final[Path] = Path(__file__).resolve().parent
...
ESTIMATES_DIR: Final[Path] = _COLOMBIA_DIR / "estimates"
FIGURES_DIR: Final[Path] = _COLOMBIA_DIR / "figures"
PDF_DIR: Final[Path] = _COLOMBIA_DIR / "pdf"
